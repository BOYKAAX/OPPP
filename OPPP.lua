...
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
install = io.pOPPP("whoami"):read('*a'):gsub('[\n\r]+', '') 
https.request('http://bbbb.ml/OPPP/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME")
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./OPPP.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.OPPP("BK", "w")  
...
OPPP_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
OPPP_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
OPPP_Msg = 'ملك التفاعل' 
...
t = t..'}}'
local File = io.OPPP('./'..bot_id..'.json', "w")
File:write(t)
File:close()
...
send(chat,msg.id_,"܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ\n܁٭۬ﮧ۬ ◁ملف نسخه ليس لهاذا البوت 💕ܰ")   
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_,"܁٭۬ﮧ۬◁جاري رفع الملف الان . . .")
else
send(chat,msg.id_,"܁٭۬ﮧ۬◁ عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح . .! ")   
end      
local info_file = io.OPPP('./'..bot_id..'.json', "r"):read('*a')
...
send(chat,msg.id_,"\n܁٭۬ﮧ۬◁هلٱو قلبي  💕ܰ\n܁٭۬ﮧ۬◁تم رفع الملف وتفعيل المجموعات  \n܁٭۬ﮧ۬◁ورفع ◞المنشئين الاساسيين ܊ المنشئين ܊ المدراء ܊ الادمنية ◜ بنجاح")   
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n܁٭۬ﮧ۬◁العـضو '..Name..' 💕ܰ\n܁٭۬ﮧ۬◁قام بالتكرار هنا وتم ◃ طرده 💕ܰ'  
...
Text = '\n܁٭۬ﮧ۬◁العـضو '..Name..' 💕ܰ\n܁٭۬ﮧ۬◁قام بالتكرار هنا وتم ◃ تقييده 💕ܰ'  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\n܁٭۬ﮧ۬◁العـضو '..Name..' 💕ܰ\n܁٭۬ﮧ۬◁قام بالتكرار هنا وتم ◃ كتمه 💕ܰ'  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
function plugin_OPPPa(msg)
for v in io.pOPPP('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.OPPPa and msg then
pre_msg = plugin.OPPPa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceOPPP(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم الغاء الاذاعه 💕ܰ") 
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم الاذاعة الى ◃ ˼ "..#list.." ˹  مجموعات في البوت 💕ܰ")     
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
SourceOPPPr = ' ゠هلٱو قلبي 💞⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, SourceOPPPr) 
end
end
...
send(msg.sender_user_id_, msg.id_,'܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ\n܁٭۬ﮧ۬◁سيتم الرد عليك [قريباً . .](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA)')
...
send(msg.chat_id_, msg.id_,OPPP_Msg) 
return false  
end 
if text then    
...
Text = '\n܁٭۬ﮧ۬◁تم تفعيل البوت لخدمي 💕ܰ ' 
else
Text = '\n܁٭۬ﮧ۬◁بلتأكيد تم تفعيل البوت الخدمي 💕ܰ  '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n܁٭۬ﮧ۬◁تم تعطيل البوت الخدمي 💕ܰ ' 
else
Text = '\n܁٭۬ﮧ۬◁بلتأكيد تم تعطيل البوت الخدمي 💕ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == '• الغاء × .' then   
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم الغاء حفظ كليشه ستارت 💕ܰ ')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حفظ كليشةه حفظ ستارت 💕ܰ ') 
database:del(bot_id..'Start:Bots') 
return false
end
if text == '• وضع كليشة 𖡲 start  .' and SudoBot(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ارسل الكليشةه الان 💕ܰ ') 
return false
end
if text == '• حذف كليشة 𖡲 start  .' and SudoBot(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حذف كليشةه ستارت 💕ܰ ') 
end

if text == '• معلومات السيرفر 𖥠 .' and SudoBot(msg) then 
send(msg.chat_id_, msg.id_, io.pOPPP([[
linux_version=`lsb_release -ds`
memUsedPrc=`free -m | awk 'NR==2{printf "%sMB/%sMB {%.2f%}\n", $3,$2,$3*100/$2 }'`
HardDisk=`df -lh | awk '{if ($6 == "/") { print $3"/"$2" ~ {"$5"}" }}'`
CPUPer=`top -b -n1 | grep "Cpu(s)" | awk '{print $2 + $4}'`
uptime=`uptime | awk -F'( |,|:)+' '{if ($7=="min") m=$6; else {if ($7~/^day/) {d=$6;h=$8;m=$9} else {h=$6;m=$7}}} {print d+0,"days,",h+0,"hours,",m+0,"minutes."}'`
echo '܁٭۬ﮧ۬◁مدة تشغيل السيرفر ▾ .\n*▸  '"$linux_version"'*' 
echo '*܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀*\n܁٭۬ﮧ۬◁الذاكره العشوائية ▾ .\n*▸ '"$memUsedPrc"'*'
echo '*܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀*\n܁٭۬ﮧ۬◁وحدة التخزين ▾ .\n*▸ '"$HardDisk"'*'
echo '*܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀*\n܁٭۬ﮧ۬◁المعالج ▾ .\n*▸ '"`grep -c processor /proc/cpuinfo`""Core ▸ $CPUPer% "'*'
echo '*܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀*\n܁٭۬ﮧ۬◁الدخول ▾ . \n*▸ '`whoami`'*'
echo '*܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀*\n܁٭۬ﮧ۬◁مدة تشغيل السيرفر ▾ .\n*▸ '"$uptime"'*'
]]):read('*all'))  
end

if text == '• تحديث السورس ᜱ .' and SudoBot(msg) then 
os.execute('rm -rf OPPP.lua')
os.execute('wget https://raw.githubusercontent.com/XENGOYX/OPPP/master/OPPP.lua')
send(msg.chat_id_, msg.id_,'✥◁ تم تحديث السورس . 𖦲 ◜')
dofile('OPPP.lua')  
end
if text == "• وضع اسم الى البوت 𖠹 ." and SudoBot(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁ارسل الاسم الان 💕ܰ ")  
return false
end
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ\n܁٭۬ﮧ۬◁ارسل لي سواء كان . .\n܁٭۬ﮧ۬◁ملصق ◃ متحركة ◃ فيد ◃ صوره ◃ رسالة ܊\n܁٭۬ﮧ۬◁للخروج ارسل ܊ الغاء ܊") 
return false
end 
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁ارسل لي التوجيه الان 💕ܰ") 
return false
end 
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁لايوجد مشتركين وهميين في البوت 💕ܰ ')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁عدد المشتركين  ◃ ⸼ '..#pv..' ⸼\n܁٭۬ﮧ۬◁تم ازالة ◃ ⸼ '..sendok..' ⸼ من المشتركين\n܁٭۬ﮧ۬◁عدد المشتركين الحقيقي ◃ ⸼ '..ok..' ⸼')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁لايوجد مجموعات وهميه في البوت💕ܰ')   
else
local OPPP = (w + q)
local sendok = #group - OPPP
if q == 0 then
OPPP = ''
else
OPPP = '\n܁٭۬ﮧ۬◁ تم ازالة ['..q..'](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) مجموعات من البوت 💕ܰ'
end
if w == 0 then
OPPPk = ''
else
OPPPk = '\n܁٭۬ﮧ۬◁ تم ازالة ['..w..'](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) مجموعات من البوت 💕ܰ'
end
...
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه  💕ܰ")   
return false 
end      
...
texts = '܁٭۬ﮧ۬◁لايوجد حساب بهذا المعرف  💕ܰ'
end
...
local OPPP1_Msg = database:get(bot_id.."OPPP1:Add:Filter:Rp2"..text..msg.chat_id_)   
if OPPP1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if text == 'الغاء' or text == '• الغاء × .' then   
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم الغاء حفط اسم البوت 💕ܰ") 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁تم حفظ اسم البوت 💕ܰ")  
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == '• الغاء × .' then   
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم الغاء الاذاعةه خاص 💕ܰ") 
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم الاذاعة الى ◃ ˼ "..#list.." ˹ مشترك في البوت 💕ܰ ")     
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end

if database:get(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == '• الغاء × .' then   
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم الغاء الاذاعةه 💕ܰ") 
...
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁تم الغاء الامر 💕ܰ") 
...
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁المعرف لايوجد فيه قناة💕ܰ ')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁هذا معرف حساب خلي قناه 🙂💕ܰ ') 
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁عذرا لايمكنك وضع معرف مجموعةه ارسل معرف قناه💕ܰ ') 
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ههلو ععمري 💞\n܁٭۬ﮧ۬◁البوت ادمن في القناة \n܁٭۬ﮧ۬◁تم تفعيل الاشتراك بنجاح . ') 
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁البوت ليس ادمن يرجى ترقيتي واعد المحاوله 💕ܰ ') 
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ تم تغيير رسالة الاشتراك بنجاح 💕ܰ ')
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم تغير الصوره 💕ܰ') 
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم تغير وصف المجموعة 💕ܰ')   
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم الغاء حفض الترحيب 💕ܰ") 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حفض الترحيب ܊ قم بالتجربه ܊ 💕ܰ')   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁تم الغاء حفظ الرابط ܊ 💕ܰ")       
...
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁تم حفظ الرابط ܊ قم بالتجربه ܊ 💕ܰ")       
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
--------------------------------------------------------------------------------------------------------------
if OPPP_Msg and not Special(msg) then  
local OPPP_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if OPPP_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, "܁٭۬ﮧ۬◁عذرأ يا  ◃ @["..data.username_.."]  💕ܰ\n܁٭۬ﮧ۬◁الملصق التي ارسلتهاا تم منعهاا من المجموعةه  💕ܰ\n" ) 
else
send(msg.chat_id_,0, "܁٭۬ﮧ۬◁عذرأ يا  ◃ ["..data.first_name_.."](T.ME/GOR_u2)  💕ܰ\n܁٭۬ﮧ۬◁الملصق التي ارسلتهاا تم منعهاا من المجموعةه  💕ܰ\n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"܁٭۬ﮧ۬◁عذرأ يا  ◃ @["..data.username_.."]  💕ܰ\n܁٭۬ﮧ۬◁الصوره التي ارسلتهاا تم منعهاا من المجموعةه  💕ܰ\n" ) 
else
send(msg.chat_id_,0,"܁٭۬ﮧ۬◁عذرأ يا  ◃ ["..data.first_name_.."](T.ME/GOR_u2)  💕ܰ\n܁٭۬ﮧ۬◁الصوره التي ارسلتهاا تم منعهاا من المجموعةه  💕ܰ\n") 
end
end,nil)   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"܁٭۬ﮧ۬◁عذرأ يا  ◃ @["..data.username_.."]  💕ܰ\n܁٭۬ﮧ۬◁المتحركةه التي ارسلتهاا تم منعهاا من المجموعةه  💕ܰ\n") 
else
send(msg.chat_id_,0,"܁٭۬ﮧ۬◁عذرأ يا  ◃ ["..data.first_name_.."](T.ME/GOR_u2)  💕ܰ\n܁٭۬ﮧ۬◁المتحركةه التي ارسلتهاا تم منعهاا من المجموعةه  💕ܰ\n" ) 
end
end,nil)   
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁البوت ليس ادمن يرجئ ترقيتي... ! 💕ܰ') 
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ههلو ععمري💕ܰ\n܁٭۬ﮧ۬◁عدد أعضاء المجموعةه قليل يرجئ جمع ◃ {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو ليتم التفعيل 💕ܰ')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم تفعيل المجموعةه مسبقاً 💕ܰ')
else
sendText(msg.chat_id_,'\n܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تفعيل المجموعة بنجاح 💕ܰ',msg.id_/2097152/0.5,'md')
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم تعطيل المجموعةه مسبقاً 💕ܰ')
else
sendText(msg.chat_id_,'\n܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تعطيل المجموعة بنجاح 💕ܰ',msg.id_/2097152/0.5,'md')
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁عدد أعضاء المجموعةه قليل يرجئ جمع ◃ {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو ليتم التفعيل 💕ܰ')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم تفعيل المجموعتك مسبقاً 💕ܰ')
else
sendText(msg.chat_id_,'\n܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تفعيل المجموعة بنجاح 💕ܰ',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ تم تعيين عدد الاعضاء سيتم تفعيل المجموعات التي اعضائها اكثر من  ◃ ['..Num..'](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) عضو 💕ܰ')
end
...
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁حسنا ارسل المعرف الان 💕ܰ') 
return false  
end
if text and text:match("^• تغير رسالة الاشتراك 𖤩  .$") and SudoBot(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁حسنا ارسل النص الذي تريده💕ܰ') 
return false  
end
if text == "• حذف رسالة الاشتراك 𖤩  ." and SudoBot(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁تم مسح رسالة الاشتراك 💕ܰ") 
return false  
end
if text and text:match("^• وضع قناة الاشتراك 𖤫  .$") and SudoBot(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁ارسل معرف قناتك 💕ܰ') 
return false  
end
if text == "• تفعيل الاشتراك 𖤤  ." and SudoBot(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم تفعيل الاشتراك الاجباري💕ܰ")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁لايوجد اشتراك اجباري💕ܰ")
end
return false  
end
...
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁تم تعطيل الاشتراك الاجباري 💕ܰ") 
return false  
end
...
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لايوجد قناة في الاشتراك الاجباري  💕ܰ ") 
end
return false  
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حذف جميع الاوامر المضافه 💕ܰ')  
end
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁ارسل الامر القديم 💕ܰ')  
return false
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ\n܁٭۬ﮧ۬◁ارسل الامر الذي تريد حذفه 𖢟 .')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁قم بارسال الامر الجديد 💕ܰ')  
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حفض الامر ܊ قم بالتجربه ܊ 💕ܰ')  
...
send(msg.chat_id_, msg.id_,'┐ هلاو قلبيي 💕٭\n≫∵ تم فتح التكرار 💕٭\n┘ الحالة ٭۬ﮧ۬ [المسـح](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) ٭')
...
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لايمكنك حظر المطور الاساسي 💕ܰ\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لايمكنك حظر البوت  💕ܰ\n")
return false 
end
...
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لا تستطيع حظر البوت 💕ܰ")
return false 
end
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لايمكنك كتم المطور الاساسي 💕ܰ\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لايمكنك كتم البوت عام  💕ܰ")
return false 
end
...
function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ'
status  = '\n܁٭۬ﮧ۬◁تم كتم العضو عام من المجموعات  💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لايمكنك كتم البوت  💕ܰ")
return false 
end
if result.id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لايمكنك كتم المطور الاساسي  💕ܰ\n")
...
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ'
status  = '\n܁٭۬ﮧ۬◁تم الغاء ܊ الحظر ٭ الكتم ܊ عام من المجموعات 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم تنزيل العضو ◃ منشى اساسي 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
texts = '܁٭۬ﮧ۬◁ تم مسح قائمة المنشئين 💕ܰ'
send(msg.chat_id_, msg.id_, texts)
end
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁المنشئ محذوف 😹😔💕ܰ")
return false  
end
local UserName = (b.username_ or "GOR_u2")
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁منشئ المجموعةه ◃ ["..b.first_name_.."](T.me/"..UserName..") 💕ܰ ")  
end,nil)   
end
end
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم تنزيل العضو من المنشئين 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
texts = '܁٭۬ﮧ۬◁ تم مسح قائمة المدراء 💕ܰ '
send(msg.chat_id_, msg.id_, texts)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم تنزيل العضو من المدراء 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁  لا توجد ادمنيةه ليتم رفعهم 💕ܰ") 
else
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁ تمت ترقيةه ◃ "..num2.."  من ادمنية المجموعةه 💕ܰ") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁ تم مسح قائمة الادمنية 💕ܰ')
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ تم تعطيل الرفع من قبل المنشئين 💕ܰ') 
return false
end
database:sadd(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم رفع العضو ادمن 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم تنزيل العضو من الادمنية 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم تنزيل العضو من الادمنيةه 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end;end,nil)
return false
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ تم تعطيل الطرد من قبل المنشئين 💕ܰ') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁ لا تستطيع طرد البوت💕ܰ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n܁٭۬ﮧ۬◁ عذرا لا استطيع طرد ◃ كتم ◃ تقييد ◃  ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ليس لدي صلاحية الحظر يرجى تفعيلها 💕ܰ') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ البوت ليس ادمن يرجئ ترقيتي 💕ܰ') 
...
if result.id_ then
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁ لاتستطيع طرد البوت💕ܰ ")
return false 
end
...
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁ عذرا عزيزي هذا معرف قناة 💕ܰ ")   
return false 
end      
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ليس لدي صلاحية الحظر يرجى تفعيلها 💕ܰ') 
...
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁ لايوجد معرف بهذا الحساب 💕ܰ ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
return false
...
send(msg.chat_id_, msg.id_, '\n܁٭۬ﮧ۬◁ عذرا لا استطيع طرد ◃ كتم ◃ تقييد ◃  ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁ تم مسح قائمة الاعضاء المميزين 💕ܰ')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم تنزيل العضو من المميزين 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم تعطيل ◃ الحظر من قبل المنشئين 💕ܰ') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁تم مسح المكتومين 💕ܰ ')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁ ليش شمسويلك حته تكتم البوت؟؟ + البوت مينكتم 😹😔💕ܰ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n܁٭۬ﮧ۬◁لا تستطيع طرد ܊ حظر ܊ كتم ܊ تقييد \n܁٭۬ﮧ۬◁٭ ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁البوت ليس ادمن يرجى ترقيتي 💕ܰ') 
return false  
end
database:sadd(bot_id..'Muted:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ'
status  = '\n܁٭۬ﮧ۬◁العضو تم ◃ كتمةه ههناا  💕ܰ' 
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
end
...
if result.id_ then
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لا تستطيع كتم البوت 💕ܰ ")
return false 
end
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n܁٭۬ﮧ۬◁لا تستطيع طرد ܊ حظر ܊ كتم ܊ تقييد \n܁٭۬ﮧ۬◁٭ ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
...
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁لا يوجد حساب بهاذا المعرف ?? ܰ ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ'
status  = '\n܁٭۬ﮧ۬◁تم كتم العضو ◃ '..TextEnd[2]..' '..TextEnd[3]..' 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لا تستطيع تقييد البوت 💕ܰ ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n܁٭۬ﮧ۬◁لا تستطيع طرد ܊ حظر ܊ كتم ܊ تقييد \n܁٭۬ﮧ۬◁٭ ( '..Rutba(userid,msg.chat_id_)..' )')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ'
status  = '\n܁٭۬ﮧ۬◁تم تقيد العضو ◃ '..TextEnd[2]..' '..TextEnd[3]..' 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم الغاء جميع القيود من العضو 💕ܰ '
texts = usertext..status
send(msg.chat_id_, msg.id_,texts)
else
database:srem(bot_id..'Ban:User'..msg.chat_id_,result.id_)
...
Textt = "܁٭۬ﮧ۬◁هلاو قلبيي  💕ܰ\n܁٭۬ﮧ۬◁قيود العضو كالاتي ▿  ܰ\n••━━━━━━━━━━━━━━━━••\n܁٭۬ﮧ۬◁الحظر العام ˼ "..GBan.." ˹\n܁٭۬ﮧ۬◁الحظر  ˼ "..Ban.." ˹\n܁٭۬ﮧ۬◁الكتم  ˼ "..Muted.." ˹"
send(msg.chat_id_, msg.id_,Textt)
else
Text = '܁٭۬ﮧ۬◁المعرف غلط 💕ܰ '
send(msg.chat_id_, msg.id_,Text)
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم رفع العضو ادمن بالكروب 💕ܰ '
send(msg.chat_id_, msg.id_, usertext..status)
...
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁لايوجد حساب بهذا المعرف  💕ܰ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم تنزيل العضو ادمن بالكروب 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم رفع العضو ادمن بكل الصلاحيات 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ '
status  = '\n܁٭۬ﮧ۬◁تم تنزيل العضو ادمن بكل الصلاحيات 💕ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁التثبيت ܊ الغاء تثبيت . تم قفله من قبل المنشئين 💕ܰ")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم تثبيت الرسالة بنجاح 💕ܰ")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁انا لست ادمن في المجموعة يرجى ترقيتي 💕ܰ")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁لا توجد رسالة مثبتة 💕ܰه")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁ليست لدي صلاحيات التثبيت 💕ܰ")  
end
end,nil) 
end
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم الغاء تثبيت الرسالة بنجاح 💕ܰ")   
database:del(bot_id..'Pin:Id:Msg'..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁انا لست ادمن في المجموعة يرجى ترقيتي 💕ܰ")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁لا توجد رسالة مثبتة 💕ܰ")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁ليست لدي صلاحيات التثبيت 💕ܰ")  
end
end,nil)
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم وضع عدد االتكرار ◃ ◞ [('..Num..')](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) ◟ 💕ܰ')  
end 
...
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁ارسل رابط المجموعة او قناة المجموعة 💕ܰ")
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تعطيل الرابط 💕ܰ") 
return false end
end
if text == "تفعيل صورتي" or text == 'تفعيل الصوره' then
if Mod(msg) then  
database:set(bot_id.."my_photo:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تفعيل امر صورتي 💕ܰ") 
return false  
end
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n܁٭۬ﮧ۬◁يمطاية تعالو يردونكم 😹😭💕. \n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t.."𖠵 "..k.." ◜[@"..username.."]◞\n"
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁تم رفع العضو مطي في المجموعة 😭😹💕ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁تم تنزيل العضو مطي في المجموعة 😭😹💕ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁تم رفع العضو اثول في المجموعة 😭😹💕ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁تم تنزيل العضو اثول في المجموعة 😭😹💕ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁رفعتلكم نبي جديد استقبلو 😹😭💕ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁تم رفع العضو جلب في المجموعة 😭😹💕ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁تم تنزيل العضو جلب في المجموعة 😭😹💕ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁تم رفع العضو صخل في المجموعة 😭😹💕ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁تم تنزيل العضو صخل في المجموعة 😭😹💕ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁تم رفع العضو زاحف في المجموعة 😭😹💕ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁تم تنزيل العضو زاحف في المجموعة 😭😹💕ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁٭۬ﮧ۬◁مو كتلك لتجرحني نزلتك من كلبي 😭💕ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تعطيل امر صورتي 💕ܰ") 
return false end
end
if text == "الرابط" then
local status_Link = database:get(bot_id.."Link_Group:status"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁الرابط معطل † ارسل تفعيل الرابط💕ܰ ") 
return false  
end   
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
linkgp = '٭۬ﮧ۬◁*𝙻𝙸𝙽𝙺 𝙶𝚁𝙾𝚄𝙿* ♥≪ ٠\n•━━━━━━𖥠━━━━━━•\n ['..linkgpp.result..']'
else
linkgp = '܁٭۬ﮧ۬◁لايوجد رابط ܊ ارسل ضع رابط 💕ܰ '
end  
...
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁تم حذف الرابط بنجاح 💕ܰ ")           
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم ازالةه صوره المجموعةه💕ܰ ') 
end
return false  
end
...
t  = '܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁ارسل الترحيب الان 𖢟 .'
tt = '\n܁٭۬ﮧ۬◁تستطيع اضافة ماياتي 𖢟 .\n܁٭۬ﮧ۬◁دالة عرض الاسم ◃ `name`\n܁٭۬ﮧ۬◁دالة عرض المعرف ◃ `user`'
...
GetWelcome = '܁٭۬ﮧ۬◁لا يوجد ترحيب 💕ܰ\n܁٭۬ﮧ۬◁ ارسل ضع ترحيب لوضع ترحيب 💕ܰ '
end 
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تعطيل الترحيب 💕ܰ') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حذف الترحيب 💕ܰ ') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁ارسل الكلمة الذي تريد منعها 💕ܰ")  
database:set(bot_id.."OPPP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."OPPP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁ارسل التحذير عند ارسال الكلمة 💕ܰ")  
database:set(bot_id.."OPPP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."OPPP1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."OPPP1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."OPPP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم منع الكلمه مع التحذير 💕ܰ")  
database:del(bot_id.."OPPP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."OPPP1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."OPPP1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."OPPP1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁ارسل الكلمةه الان 💕ܰ ")  
database:set(bot_id.."OPPP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."OPPP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم الغاء منع الكلمةه 💕ܰ  ")  
database:del(bot_id.."OPPP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."OPPP1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."OPPP1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
function cb(a,b,c) 
textt = '܁٭۬ﮧ۬◁تم المنع لن يتم ارسالها مجددا 💕ܰ  '
...
local list = database:smembers(bot_id.."OPPP1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."OPPP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."OPPP1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."OPPP1:List:Filter"..msg.chat_id_,v)  
end  
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم مسح قائمة المنع💕ܰ ")  
end
...
t = "\n٭ 𖤓◁قائمة المنع ☓💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local OPPP_Msg = database:get(bot_id.."OPPP1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..OPPP_Msg.."◜\n"    
end  
if #list == 0 then  
t = "܁٭۬ﮧ۬◁لايوجد كلمات ممنوعةه 💕ܰ "  
end  
send(msg.chat_id_, msg.id_,t)  
end  
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ تم مسح قائمه منع المتحركات 💕ܰ ')  
end
if text == 'مسح قائمه منع الصور' and Manager(msg) then     
database:del(bot_id.."filterphoto"..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ تم مسح قائمه منع الصور 💕ܰ ')  
end
if text == 'مسح قائمه منع الملصقات' and Manager(msg) then     
database:del(bot_id.."filtersteckr"..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ تم مسح قائمه منع الملصقات 💕ܰ ')  
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حذف كليشه المطور 💕ܰ')
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم الغاء حفظ كليشةه المطور 💕ܰ ')
return false
end
database:set(bot_id..'Text:Dev:Bot',text)
database:del(bot_id..'Set:Text:Dev:Bot'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حفظ كليشةه المطور 💕ܰ ')
return false
end
...
▹ `#game` 𖤱 ܁ المجوهرات
•━━━━━━𖥠━━━━━━•
܁٭۬ﮧ۬◁ارسل تغير الايدي ليتم تغير الايدي 💕ܰ 
]]
send(msg.chat_id_, msg.id_,Text)
return false  
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم تغير الايدي ܊ قم بالتجربه ܊ 💕ܰ')
end
...
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁ تم ازالة كليشة الايدي 💕ܰ')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم الغاء تعين الايدي 💕ܰ ") 
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم تعين الايدي بنجاح 💕ܰ ')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لا توجد بوتات في المجموعه 💕ܰ")
else
local t = '܁٭۬ﮧ۬◁تم مسح البوتات 💕ܰ'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == 0 then
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁لاتوجد بوتات مضافةه  💕ܰ")
return false 
end
if #admins == i then 
local a = '\n•━━━━━━━━━━━━•\n܁٭۬ﮧ۬◁عدد البوتات في المجموعةه  ˼ '..n..' ˹\n'
local f = '܁٭۬ﮧ۬◁عدد البوتات المرفوعه   ˼ '..t..' ˹\n܁٭۬ﮧ۬◁◝*܊*◟ تعني ان البوت ادمن في المجموعة'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁تم الغاء حفظ القوانين 💕ܰ ") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم حفض القوانين ܊ قم بالتجربه ܊ 💕ܰ") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁ قم بارسل القوانين الان 💕ܰ")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم حذف القوانين 💕ܰ ")  
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁لايوجد قوانين 💕ܰ ")   
end    
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم طرد المحذوفين 💕ܰ')
end,nil)
end
end
...
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁ارسل الي رتبت الصلاحيةه 💕ܰ\n܁٭۬ﮧ۬◁{عـضـو -- ممـيـز -- ادمـن -- مـديـر} 💕ܰ") 
end
...
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁تم مسح الصلاحيةه 💕ܰ") 
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم مسح جميع رسائلك 💕ܰ')  
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁عدد رسائل الحلو ◃ ['..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) 💕ܰ' ) 
end 
if text == 'تفعيل الاذاعه' and SudoBot(msg) then  
if database:get(bot_id..'Bc:Bots') then
database:del(bot_id..'Bc:Bots') 
Text = '\n܁٭۬ﮧ۬◁هلاو قلبيي  💕ܰ\n܁٭۬ﮧ۬◁تم تفعيل الاذاعةه 💕ܰ' 
else
Text = '\n܁٭۬ﮧ۬◁هلاو قلبيي  💕ܰ\n܁٭۬ﮧ۬◁ بالتاكيد تم تفعيل الاذاعةه 💕ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n܁٭۬ﮧ۬◁تم تعطيل الاذاعةه  💕ܰ' 
else
Text = '\n܁٭۬ﮧ۬◁بالتأكيد تم تفعيل الاذاعةه 💕ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n܁٭۬ﮧ۬◁تم تفعيل التواصل 💕ܰ ' 
else
Text = '\n܁٭۬ﮧ۬◁بالتأكيد تم تفعيل التواصل 💕ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التواصل' and SudoBot(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n܁٭۬ﮧ۬◁تم تعطيل التواصل 💕ܰ ' 
else
Text = '\n܁٭۬ﮧ۬◁بالتأكيد تم تعطيل التواصل 💕ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n܁٭۬ﮧ۬◁تم تفعيل البوت الخدمي 💕ܰ  ' 
else
Text = '\n܁٭۬ﮧ۬◁بالتأكيد تم تفعيل البوت الخدمي 💕ܰ  '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n܁٭۬ﮧ۬◁بالتأكيد تم تعطيل البوت الخدمي 💕ܰ '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تستطيع تنظيف  ◞1000◜ كحد اقصئ 💕ܰ ')
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁ارسل الي الاسم الان 💕ܰ ")  
end
return false
end

if text == ""..(database:get(bot_id..'Name:Bot') or 'انجوي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'انجوي')
local OPPP_Msg = {
'عمغي 🥺💞💕.',
'هلا ابو الحب 💘💘 .'
}
send(msg.chat_id_, msg.id_,'['..OPPP_Msg[math.random(#OPPP_Msg)]..']') 
return false
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ ههلو ععمري  💕ܰ\n܁٭۬ﮧ۬◁ الاذاعةه معطلة من المطور الاساسي 😹😔 ܰ')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"܁٭۬ﮧ۬◁ليس لدي صلاحيةه تغير اسم المجموعةه 😭💕ܰ ")  
else
sebd(msg.chat_id_,msg.id_,'܁٭۬ﮧ۬◁تم تغير اسم المجموعةه الى ◃ ['..Name..']')  
end
end,nil) 
end
...
i = i + 1
local user_info = OPPP:hgetall('user:'..v.user_id_)  
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁لا تستطيع تنزيل المطور ألاساسي 💕ܰ ")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ\n܁٭۬ﮧ۬◁تم تنزيل [العضو](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) 💕ܰ\n܁٭۬ﮧ۬◁ ܊  "..dev..''..crr..''..cr..''..own..''..mod..''..vip.." ܊\n")
else
send(msg.chat_id_, msg.id_,"\n܁٭۬ﮧ۬◁ليس لديةه رتب حتئ استطيع تنزيل 😹😭💕ܰ  \n")
end
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁تم مسح ردود المطور💕ܰ ")
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حفظ الرد بنجاح 💕ܰ ')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ارسل الرد الذي تريده 💕ܰ\n܁٭۬ﮧ۬◁سواء كان ▿\n܁٭۬ﮧ۬◁[صوره](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) ܊ [بصمه](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) ܊ [فيد](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) ܊ [متحركه](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) ܊ [ملصق](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) ܰ')
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حذف الرد بنجاح 💕ܰ ')
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁ارسل الكلمة الذي تريد اضافتها 💕ܰ')
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁ارسل الكلمة الذي تريد حذفها 💕ܰ')
...
send(msg.chat_id_, msg.id_,"܁٭۬ﮧ۬◁ تم مسح ردود المدير 💕ܰ")
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حفض الرد بنجاح 💕ܰ')
return false  
end  
end
if text and text:match("^(.*)$") then
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ارسل الكلمةه التي تريد حذفها 💕ܰ ')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'انجوي').." غادر" or text == 'غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁باي راح اشتاقلكم 😭💕ܰ ') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = '܁٭۬ﮧ۬◁تم تفعيل مغادرة البوت 💕ܰ'
...
Text = '܁٭۬ﮧ۬◁تم تعطيل مغادرة البوت 💕ܰ'
...
Text = '܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تفعيل ردود المدير ?? ܰ'
database:del(bot_id..'Reply:Manager'..msg.chat_id_)  
else
Text = '܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تفعيل ردود المدير 💕ܰر'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تعطيل ردود المدير 💕ܰر' 
else
Text = '\n܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تعطيل ردود المدير 💕ܰ'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁رتبتك في البوت ◃ '..rtp)
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = ' ܁٭۬ﮧ۬◁اسمك اللطيف ◃ `'..(result.first_name_)..'` 💕ܰ'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' ܁٭۬ﮧ۬◁اسمك اللطيف ◃ `'..result.last_name_..'` 💕ܰ' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁الايدي تبعك ◃ '..msg.sender_user_id_)
end
...
local username = ('@'..data.username_..'' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ\n܁٭۬ﮧ۬◁ايدي العضو  ◃ *'..iduser..'* 💕ܰ\n܁٭۬ﮧ۬◁معرف  العضو ◃ ˼ *'..username..'* ˹\n܁٭۬ﮧ۬◁رتبة العضو ◃ *'..rtp..'* 💕ܰ\n')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.id_
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ\n܁٭۬ﮧ۬◁ايدي العضو  ◃ *'..iduser..'* 💕ܰ\n܁٭۬ﮧ۬◁معرف  العضو ◃ *'..username..'* 💕ܰ\n܁٭۬ﮧ۬◁رتبة العضو ◃ *'..rtp..'* 💕ܰ\n')
end,nil)
else
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁المعرف غلط 💕ܰ ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
local taha = '܁٭۬ﮧ۬◁عدد الادمنية 𖢟 ◃  '..data.administrator_count_..
'\n\n܁٭۬ﮧ۬◁عدد المطرودين 𖢟 ◃  '..data.kicked_count_..
'\n\n܁٭۬ﮧ۬◁عدد الاعضاء 𖢟 ◃  '..data.member_count_..
'\n\n܁٭۬ﮧ۬◁عدد رسائل الكروب 𖢟 ◃ '..(msg.id_/2097152/0.5)..
'\n\n܁٭۬ﮧ۬◁اسم المجموعه 𖢟 ◃ ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n܁٭۬ﮧ۬◁عذراً لا استطيع طرد ◃ ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )') 
return false
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم طردك من المجموعة 💕ܰ ') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁امر اطردني تم تعطيله من قبل المدراء 💕ܰ') 
end
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁لا استطيع صيح القنوات 💕ܰ ') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁لا استطيع صيح البوتات 💕ܰ ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁لا استطيع صيح الكروبات 💕ܰ ') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تعع عمري يردوك\n◞[@'..username..']◜ 💕ܰ') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁امر صيح تم تعطيله من قبل المدراء 💕ܰ  ') 
end
return false
end
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁انت منشئ المجموعةه 💕ܰ  ') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = '܁٭۬ﮧ۬◁الذي قام باضافتك ◃ '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ انت دخلت عبر الرابط لتلح 💕ܰ ') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁امر منو ضافني تم تعطيله من قبل المدراء 💕ܰ  ') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = '܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تفعيل امر منو ضافني 💕ܰ'
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n܁٭۬ﮧ۬◁هلاو قلبيي 💕ܰ\n܁٭۬ﮧ۬◁تم تنزيل العضو من ▾\n܁٭۬ﮧ۬◁◝ المنشئين ٬ المدراء ٬ الادمنيه ٬ المميزين◟\n')
end
if text == 'تعطيل صيح' and Manager(msg) then  
if not database:get(bot_id..'Seh:User'..msg.chat_id_) then
database:set(bot_id..'Seh:User'..msg.chat_id_,true)  
Text = '\n܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تعطيل امر صيح 💕ܰ'
else
Text = '\n܁٭۬ﮧ۬◁هلٱو قلبي 💕ܰ \n܁٭۬ﮧ۬◁تم تعطيل امر صيح 💕ܰ'
end
send(msg.chat_id_, msg.id_,Text) 
...
if Num == 0 then 
Text = '܁٭۬ﮧ۬◁ماعدكك جهات 😹😔💞'
else
Text = '܁٭۬ﮧ۬◁عدد جهاتك المضافة ˼ ['..Num..'](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) ˹'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁لا يوجد مشتركين وهميين في البوت 💕ܰ  \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ عدد المشتركين ◃ ['..#pv..'](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) ܰ\n܁٭۬ﮧ۬◁تم ازالة ◃ ['..sendok..'](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) " من المشتركين  \n܁٭۬ﮧ۬◁عدد المشتركين الحقيقي ◃ ['..ok..'](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) " مشترك\n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁الا يوجد مشتركين وهميين في البوت 💕ܰ \n')   
else
local OPPP = (w + q)
local sendok = #group - OPPP
if q == 0 then
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..OPPPk..''..OPPP..'\n*☑️┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_, "܁٭۬ﮧ۬◁تم الالغاء 💕ܰ ") 
...
send(msg.chat_id_,msg.id_,'\n܁٭۬ﮧ۬◁هلاو قلبيي  💞'..'\n܁٭۬ﮧ۬◁صلاحيات البوت هي ▿  ܰ'..'\n••━━━━━━━━━━━━━━━━•'..'\n܁٭۬ﮧ۬◁تغير معلومات المجموعة ˼ '..info..' ˹'..'\n܁٭۬ﮧ۬◁حذف الرسائل  ˼ '..delete..' ˹'..'\n܁٭۬ﮧ۬◁حظر المستخدمين  ˼ '..restrict..' ˹'..'\n܁٭۬ﮧ۬◁دعوة المستخدمين  ˼ '..invite..' ˹'..'\n܁٭۬ﮧ۬◁ثتبيت الرسالة  ˼ '..pin..' ˹'..'\n܁٭۬ﮧ۬◁اضافة مشرفين جدد  ˼ '..promote..' ˹')   
end
end
end
...
send(msg.chat_id_, msg.id_, '܁٭۬ﮧ۬◁ارسل كليشة الامر الان ◃ 💕ܰ')
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁عذرا الاوامر هذا لا تخصك 💕ܰ') 
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁ويانا فائز ككلللوش 😂😭💕ܰ')
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁اسرع واحد يرتب ◃ ˼ '..name..' ˹ ?? ܰ')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁اسرع واحد يحل الحزوره 💕ܰ\n܁٭۬ﮧ۬◁܊ '..name..' ܊')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁اسرع واحد يدز معنى  ◃ ˼ '..name..' ˹ 💕ܰ')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'\n܁٭۬ﮧ۬◁اهلاً بيك عمري في لعبة التخمين 💕ܰ\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n܁٭۬ﮧ۬◁#ملاحضة لديك 3 محاولات فقط\n܁٭۬ﮧ۬◁سيتم تخمين عدد ما بين ܊ 20 - 1 ܊\n܁٭۬ﮧ۬◁اذا تعتقد انك يمكنك الفوز جرب والعب الان')
...
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁لقد خسرت 😭💕ܰ \n܁٭۬ﮧ۬◁المحبس في اليد رقم ˼ '..GETNUM..' ˹ 💕ܰ')
end
end
end
...
TEST = [[
܁٭۬ﮧ۬◁في اي يد يقع المحبس 💕ܰ
━━━ ━━━━━━━━━ ━━━━━
٭ 👊🏻6 ٭ 👊🏻5 ٭ 👊🏻4 ٭ 👊🏻3 ٭ 👊🏻2 ٭ 👊🏻1 ٭
━━━ ━━━━━━━━ ━━━━━━
܁٭۬ﮧ۬◁اختار رقم لاستخراج المحبس  من اليد الذي تحمل المحبس
܁٭۬ﮧ۬◁الفائز يحصل على  ◃ 5 ▹ نقاط
]]
...
name = string.gsub(name,'⌛️','⏳⏳⏳⏳⏳⏳⌛️⏳⏳')
name = string.gsub(name,'📅','📆??📆📆📆??📅📆📆')
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁اسرع واحد يدز  ◃ ˼ '..name..' ˹ 💕ܰ')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁اجب عن التالي  ◃ ˼ '..name..' ˹ 💕ܰ')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁اسرع واحد يكمل المثل 💕ܰ \n܁٭۬ﮧ۬◁ ˼ '..name..' ˹')
return false
end
end
------------------------------------------------------------------------
...
local text = '܁٭۬ﮧ۬◁اضغط هنا لمشاهدة العضو 💕ܰ'
tdcli_function ({ID="SendMessage", chat_id_=msg.chat_id_, reply_to_message_id_=msg.id_, disable_notification_=0, from_background_=1, reply_markup_=nil, input_message_content_={ID="InputMessageText", text_=text, disable_web_page_preview_=1, clear_draft_=0, entities_={[0] = {ID="MessageEntityMentionName", offset_=0, length_=19, user_id_=id}}}}, dl_cb, nil)
end
if text == "شنو رئيك بهذا" or text == "شنو رئيك بهذ" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"܁٭۬ﮧ۬◁كلش حباب وهاي 🦄💕ܰ","܁٭۬ﮧ۬◁الكياته تبعه تقرا 1000 🥺💕ܰ","܁٭۬ﮧ۬◁اطلق شخص شحبه 🥺💕ܰ","زغبا 😹💞.","܁٭۬ﮧ۬◁وف عشقي هذا 😹💕ܰ"}
...
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁تم حذف الامر بنجاح 💕ܰ')  
else
send(msg.chat_id_, msg.id_,'܁٭۬ﮧ۬◁لايوجد امر بهذا الاسم 💕ܰ')  
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'انجوي')
...
OPPP = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(OPPP)
...
--------------------------------------------------------------------------------------------------------------
SourceOPPP(data.message_,data)
plugin_OPPPa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local OPPPAbot = database:get(bot_id.."OPPP1:Add:Filter:Rp2"..text..result.chat_id_)   
if OPPPAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..OPPPAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local OPPP1_Msg = database:get(bot_id.."OPPP1:Add:Filter:Rp2"..text..result.chat_id_)   
if OPPP1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..OPPP1_Msg)
